...
public class ClearEditText extends AppCompatEditText {
    ...
    public ClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        separator = a.getString(R.styleable.ClearEditText_separator);
        if (separator == null) {
            separator = "";
        }
        customizeMarkerEnable = a.getBoolean(R.styleable.ClearEditText_markerEnable, false);
        int which = a.getInt(R.styleable.ClearEditText_showMarkerTime, 0);
        switch (which) {
            case 0:
        ...
        iOSStyleEnable = a.getBoolean(R.styleable.ClearEditText_iOSStyleEnable, false);
        disableEmoji = a.getBoolean(R.styleable.ClearEditText_disableEmoji, false);
        a.recycle();
    ...
    private void init() {
        if (getInputType() == InputType.TYPE_CLASS_NUMBER) {
            // if inputType="number", it can't insert separator.
            setInputType(InputType.TYPE_CLASS_PHONE);
        }

        mTextWatcher = new ClearTextWatcher();
        ...
        if (mRightMarkerDrawable == null) {
            // didn't customize Marker
            mRightMarkerDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.icon_edit_clear);
