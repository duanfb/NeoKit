...
import com.neo.kit.upgrade.entity.PromptEntity;
import com.neo.kit.upgrade.entity.UpdateEntity;
import com.neo.kit.upgrade.listener.IUpdateParseCallback;
...
import com.neo.kit.upgrade.utils.UpdateUtils;

import java.util.Map;
import java.util.TreeMap;

import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_NO_NETWORK;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_NO_NEW_VERSION;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_NO_WIFI;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.PROMPT_ACTIVITY_DESTROY;
...
public class UpdateManager implements IUpdateProxy {
    ...
    @Override
    public void update() {
        Log.d(TAG, "XUpdate.update()启动:" + toString());
    ...
    public void noNewVersion(@NonNull Throwable throwable) {
        Log.i(TAG, "未发现新版本:" + throwable.getMessage());
        if (mIUpdateProxy != null) {
    ...
    public void startDownload(@NonNull UpdateEntity updateEntity, @Nullable OnFileDownloadListener downloadListener) {
        Log.i(TAG, "开始下载更新文件:" + updateEntity);
        updateEntity.setIUpdateHttpService(mIUpdateHttpService);
        if (mIUpdateProxy != null) {
    ...
    public void backgroundDownload() {
        Log.i(TAG, "点击了后台更新按钮, 在通知栏中显示下载进度...");
        if (mIUpdateProxy != null) {
