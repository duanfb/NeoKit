...
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_APK_CACHE_DIR_EMPTY;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_IGNORED_VERSION;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_NO_NEW_VERSION;
import static com.neo.kit.upgrade.entity.UpdateError.ERROR.CHECK_PARSE;
...
public final class UpdateUtils {
    ...
    public static boolean isPrivateApkCacheDir(@NonNull UpdateEntity updateEntity) {
        return FileUtils.isPrivatePath(FpUpdate.getContext(), updateEntity.getApkCacheDir());
    }
    ...
    public static String getDefaultDiskCacheDirPath() {
        return UpdateUtils.getDiskCacheDir(FpUpdate.getContext(), KEY_XUPDATE);
    }
