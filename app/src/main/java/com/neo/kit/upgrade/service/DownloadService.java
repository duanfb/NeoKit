...
package com.neo.kit.upgrade.service;
...
import com.neo.kit.upgrade.FpUpdate;
...
import com.neo.kit.upgrade.utils.ApkInstallUtils;
import com.neo.kit.upgrade.utils.FileUtils;
import com.neo.kit.upgrade.utils.UpdateUtils;

import java.io.File;

import static com.neo.kit.upgrade.entity.UpdateError.ERROR.DOWNLOAD_FAILED;
...
public class DownloadService extends Service {
    ...
    public static void bindService(ServiceConnection connection) {
        Intent intent = new Intent(FpUpdate.getContext(), DownloadService.class);
        FpUpdate.getContext().startService(intent);
        FpUpdate.getContext().bindService(intent, connection, Context.BIND_AUTO_CREATE);
        mIsRunning = true;
    }
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private void startDownload(@NonNull UpdateEntity updateEntity, @NonNull FileDownloadCallBack fileDownloadCallBack) {
        ...
        Log.d(TAG, "开始下载更新文件, 下载地址:" + apkUrl + ", 保存路径:" + target + ", 文件名:" + apkName);
